...
<body>
    <form name="frmSaco" action="SAgregarSaco"  method="post">
...
<article class="card-body">
	...
	<a href="MostrarSacos.jsp" class="btn  btn-outline-warning"> Regresar </a>
</article>
		</aside> 
	</div>
</main> 
    ...
    <%}
            ...
            response.sendRedirect("MostrarSacos.jsp"); 
        }%>
</body>
</html>