...
<div class="container">
 <h2 class="h1-responsive font-weight-bold text-center my-5">Corbatas</h2>
  <p class="grey-text text-center w-responsive mx-auto mb-5">Nuestro Catálogo de Sacos</p>
<div class="row-sm">
    <%
            for(Corbata cor:vecCor){
                String direccion="AgregarCorbata.jsp?id=" +cor.getCorbata_id();
          %>
<div class="col-md-3 col-sm-6">
	<figure class="card card-product">
		<div class="img-wrap"> 
                    <a href="<%=cor.getCorbata_imagen()%>" data-fancybox=""> <img src="<%=cor.getCorbata_imagen()%>"></a>
                </div>
		<figcaption class="info-wrap ">
			<a href="#" class="title "><%=cor.getCorbata_descripcion()%></a>
