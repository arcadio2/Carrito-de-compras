...
<div class="container">
 <h2 class="h1-responsive font-weight-bold text-center my-5">Pantalones</h2>
  <p class="grey-text text-center w-responsive mx-auto mb-5">Nuestro Catálogo de Pantalones.</p>
<div class="row-sm">
    <%
            for(Pantalon pan:vecPan){
                String direccion="AgregarPantalon.jsp?id=" +pan.getPantalon_id();
          %>
<div class="col-md-3 col-sm-6">
	<figure class="card card-product">
            <div class="img-wrap"><a href="<%=pan.getPantalon_imagen()%>" data-fancybox="">  <img src="<%=pan.getPantalon_imagen()%>"></a></div>
		<figcaption class="info-wrap ">
			<a href="#" class="title "><%=pan.getPantalon_descripcion()%></a>
			<div class="price-wrap " >
				<span class="price-new"><a href="<%= direccion%>" >Agregar</a></span>
			</div> 
		</figcaption>
	</figure>
</div>
