...
<body>
    <form name="frmZapato" action="SAgregarZapato"  method="post">
...
<article class="card-body">
	...
	<a href="MostrarZapatos.jsp" class="btn  btn-outline-warning"> Regresar </a>
</article>
		</aside> 
	</div>
</main> 
    ...
    <%}else{
    response.sendRedirect("MostrarZapatos.jsp");
}%>
</body>
</html>