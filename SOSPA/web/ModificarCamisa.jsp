...
<body>
    <form name="frmMCamisa" action="SModificarCamisa"  method="post">
...
<article class="card-body">
	...
	<a href="CambiarCamisa.jsp" class="btn  btn-outline-warning"> Regresar </a>
</article>
		</aside> 
	</div>
</main> 
    ...
    <%}else{
    response.sendRedirect("CambiarCamisa.jsp"); 
    }
