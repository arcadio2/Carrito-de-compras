...
<div class="container">
 <h2 class="h1-responsive font-weight-bold text-center my-5">Sacos</h2>
  <p class="grey-text text-center w-responsive mx-auto mb-5">Nuestro Catálogo de Sacos.</p>
<div class="row-sm">
    <%
            for(Saco sac:vecSac){
                String direccion="AgregarSaco.jsp?id=" +sac.getSaco_id();
          %>
<div class="col-md-3 col-sm-6">
	<figure class="card card-product">
		<div class="img-wrap"> 
                    <a href="<%=sac.getSaco_imagen()%>" data-fancybox=""> <img src="<%=sac.getSaco_imagen() %>"></a>
                </div>
		<figcaption class="info-wrap ">
			<a href="#" class="title "><%=sac.getSaco_descripcion()%></a>
