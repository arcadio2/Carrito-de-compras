...
<body>
    <form name="frmMPan" action="SModificarPantalon"  method="post">
...
<article class="card-body">
	...
	<a href="CambiarPantalon.jsp" class="btn  btn-outline-warning"> Regresar </a>
</article>
		</aside> 
	</div>
</main> 
    ...
    <%}else{
    response.sendRedirect("CambiarPantalon.jsp");
    }
