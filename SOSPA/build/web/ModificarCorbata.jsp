...
<body>
    <form name="frmMCorbata" action="SModificarCorbata"  method="post">
...
<article class="card-body">
	...
	<a href="CambiarCorbata.jsp" class="btn  btn-outline-warning"> Regresar </a>
</article>
		</aside> 
	</div>
</main> 
    ...
    <% }else{
    response.sendRedirect("CambiarCorbata.jsp");
}%>
</body>
</html>