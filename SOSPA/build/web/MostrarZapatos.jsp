...
<div class="container">
 <h2 class="h1-responsive font-weight-bold text-center my-5">Zapatos</h2>
  <p class="grey-text text-center w-responsive mx-auto mb-5">Nuestro Catálogo de Zapatos.</p>
<div class="row-sm">
    <%
            for(Zapato zap:vecZap){
                String direccion="AgregarZapato.jsp?id=" +zap.getZapato_id();
          %>
<div class="col-md-3 col-sm-6">
	<figure class="card card-product">
		<div class="img-wrap"> 
                    <a href="<%=zap.getZapato_imagen()%>" data-fancybox=""> <img src="<%=zap.getZapato_imagen()%>"></a>
                </div>
		<figcaption class="info-wrap ">
			<a href="#" class="title "><%=zap.getZapato_descripcion()%></a>
