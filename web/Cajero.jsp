...
<%
    ...
    Vector<Venta> vecVen = new Venta().listaTVentas();
                                ...
                                <tbody>
                                    ...
                                    <%
                                        for (Venta ven : vecVen) {
                                            ...
                                            String direccion = "";
                                            direccion = "DetalleVentaC.jsp?id=" + ven.getVenta_codigo();
                                            ID obj = new ID();
                                            obj.setId(ven.getUsuario_codigo());
                                            //  obj.setId(ven.getUsuario_codigo());
                                            //obj.setId(); 
                                            String username = ConexionUsuario.getAllById(obj).getUsuario();
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"> 
                                            <form action="SConfirmarVentas" method="post">
                                                <input type="hidden" id="total" name="tot" value="<%=ven.getVenta_totalpagar()%>">
                                                <input type="text" hidden id="idven" name="idven" value="<%=ven.getVenta_codigo()%>">
                                                <button type="submit" onlyread class="btn btn-outline-success">Confirmar Pago </button>
                                            </form>
                                        </td>
                                    </tr>
                                    <%}%>
