                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-wrapper">
                            ...
                            <a class="navbar-brand">Modificar usuario</a>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="agregaproducto">
                                ...
                                <form method="post" action="AgregarSubproducto" id="subproducto" onkeypress="EnterUsuario(event)">
                                    <%
                                        Statement set = null;
                                        ResultSet rs = null;
                                        ...
                                        try {
                                            ...
                                            rs = set.executeQuery("select * from usuario where id_us = " + id + ";");
                                            rs.last();
                                    ...
                                    <input type="text" minlength="3" maxlength="20" autocomplete="off" name="nombre" id="subproducto-2" value="<%=rs.getString(2)%>">
                                    <p class="tit">Correo: </p>
                                    <input type="text" minlength="1" maxlength="40" autocomplete="off" name="correo" id="subproducto-3" value="<%=rs.getString(3)%>">
                                    <p class="tit">Contraseña: </p>
                                    <input type="password" minlength="1" maxlength="50" autocomplete="off" name="contraseña" id="subproducto-4">
                                    <p class="tit">Confirmar contraseña: </p>
                                    <input type="password" minlength="1" maxlength="50" autocomplete="off" name="contraseña2" id="subproducto-5">
                                    <input type="hidden" value="<%=id%>" name="id">
                                </form>
                                <button class="agregar" onclick="ValidaUsuarioModifica()">Aceptar</button>
                            </div>
                        </div>
                    </div>          
                </div>
