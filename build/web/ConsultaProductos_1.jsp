                ...
                <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-wrapper">
                            ...
                            <a class="navbar-brand">Consultar Productos</a>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="contenido">
                                ...
                                %>
                                <div class="cual">
                                    <p class="prod">PASTELES</p>
                                </div>
                                <%
                                    rs = set.executeQuery("select * from subproducto where id_pro = 1");
                                    while (rs.next()) {
                                %>
                                <div class="pro">
                                    <div class="imagen">
                                    ...
                                    <div class="modify-2">
                                        <a href="MSubproductos.jsp?id=<%=rs.getInt(1)%>" class="modi">
                                            Modificar
                                        </a>
                                    </div>
                                    <div class="delete-2">
                                        ...
                                        <div class="collapse" id="confirmar<%=rs.getInt(1)%>">
                                            ...
                                            <a href="EliminarSubproductos?id=<%=rs.getInt(1)%>" class="acept">
                                                Aceptar
                                            </a>
                                        </div>
                                    </div>
                                ...
                                %>
                                <div class="cual">
                                    <p class="prod">PAN DULCE</p>
                                </div>
                                <%
                                    rs = set.executeQuery("select * from subproducto where id_pro = 2");
                                    while (rs.next()) {
                                %>
                                <div class="pro">
                                    <div class="imagen">
                                ...
                                %>
                                <div class="cual">
                                    <p class="prod">HELADOS</p>
                                </div>
                                <%
                                    rs = set.executeQuery("select * from subproducto where id_pro = 3");
                                    while (rs.next()) {
                                %>
                                <div class="pro">
                                    <div class="imagen">
                                    ...
                                    <div class="delete-2">
                                        <a data-toggle="collapse" href="#confirmar<%=rs.getInt(1)%>">
                                            <p>Eliminar</p>
                                        </a>
                                        <div class="collapse" id="confirmar<%=rs.getInt(1)%>">
                                            <p>¿Esta segúro de eliminar este elemento?, el cambio sera permanente</p>
                                            <a href="EliminarSubproductos?id=<%=rs.getInt(1)%>">
                                                Aceptar
                                            </a>
                                        </div>
                                    </div>
                                ...
                                %>
                                <div class="cual">
                                    <p class="prod">GELATINAS</p>
                                </div>
                                <%
                                    rs = set.executeQuery("select * from subproducto where id_pro = 4");
                                    while (rs.next()) {
                                %>
                                <div class="pro">
                                    <div class="imagen">
                                ...
                                %>
                                <div class="cual">
                                    <p class="prod">PAN SALADO</p>
                                </div>
                                <%
                                    rs = set.executeQuery("select * from subproducto where id_pro = 5");
                                    while (rs.next()) {
                                %>
                                <div class="pro">
                                    <div class="imagen">
                                ...
                                %>
                                <div class="cual">
                                    <p class="prod">DONAS</p>
                                </div>
                                <%
                                    rs = set.executeQuery("select * from subproducto where id_pro = 6");
                                    while (rs.next()) {
                                %>
                                <div class="pro">
                                    <div class="imagen">
